...
function AcercaDe() {
  return (
    <div className="text-white w-full h-full flex flex-col items-center gap-[18px] px-4 md:px-8">
      <h2 className="text-[25px] md:text-[60px] font-header font-black">Acerca De</h2>
      <p className="text-center font-paragraph font-extrabold leading-[18px] md:leading-[34px]   text-[11px] md:text-[20px]">
      ...
      text={"Servicios"}
      />
      <Image src="/assets/acerca/acercade/bmw.png" width={1000} height={1000} alt="Acerca De" className="w-full h-full md:h-[500px] md:object-contain flex flex-col " />
      ...
      <div className="md:w-[530px] text-right">
