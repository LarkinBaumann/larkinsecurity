  ...
  return (
   <div className='w-full h-screen relative  '>
    <div className='w-full h-full'>
        ...
        <Image src={isLarge?"/assets/home/hero2.png":"/assets/home/hero.png"} width={1000} height={1000} alt='hero image' className='w-full h-full object-fill lg:object-cover md:object-bottom' />
   </div>
