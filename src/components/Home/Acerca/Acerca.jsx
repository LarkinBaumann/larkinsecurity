...
function Acerca() {
  return (
    <div className='w-full h-full flex flex-col lg:flex-row-reverse items-center justify-center relative'>
      <ShadowTop/>

      <div className='w-full h-[300px] lg:h[500px] flex flex-row justify-center items-center relative '>
        ...
        <div className='w-[700px] lg:w-full h-[200px] lg:h-full flex flex-col items-center justify-center'>
          <div className='flex w-full justify-center items-center'>


      <div className='w-[222px] lg:w-[354px] h-[189px] lg:h-[300px] translate-x-[30%] lg:translate-x-[0%] z-20'>
            <Image src='/assets/home/acerca/1.png' width={1920} height={1080} alt='Acerca de nosotros' className='w-full h-full' />
        </div>
        <div className='w-[222px] lg:w-[354px] h-[189px] lg:h-[300px] -translate-x-[20%] lg:-translate-x-[40%] translate-y-[20%]  z-10'>
            <Image src='/assets/home/acerca/2.png' width={1920} height={1080} alt='Acerca de nosotros' className='w-full h-full' />
        </div>
          </div>
        </div>
        </div>
        <div className='w-full h-full flex flex-col items-center lg:items-start justify-center  text-white text-center lg:text-left gap-[15px] px-4'>
            ...
            <p className='text-[13px] md:text-[20px] md:leading-[34px] font-paragraph leading-[22px] z-20 '>
