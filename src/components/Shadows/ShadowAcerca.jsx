...
useEffect(() => {
  ...
  return (
    ...
    initial="hidden"
        animate={"visible"}
        variants={variants}
    className='w-full  absolute top-[300px] -left-[450px] lg:top-[200px] lg:left-[150px] -z-20  lg:-z-10'>
        <svg width="700" height={isTabletOrMobile?"650":"1054"} viewBox="0 0 984 1054" fill="none" xmlns="http://www.w3.org/2000/svg">
